...
const Process: React.FC = () => {
  ...
  return (
    <section id="process" className="py-24 sm:py-32 relative overflow-hidden" ref={ref as React.RefObject<HTMLElement>}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {steps.map((step, index) => (
            ...
            >
              ...
              <h3 className="text-xl sm:text-2xl font-black text-slate-900 mb-2 group-hover:text-blue-600 transition-colors">{step.title}</h3>
              <p className="text-base sm:text-lg text-blue-600 font-bold mb-4 opacity-80">{step.subtitle}</p>
          ...
          {/* CTA Card */}
          <div className="lg:col-span-1 ice-button rounded-[2.5rem] p-8 sm:p-10 flex flex-col justify-center items-center text-center text-white gradient-shadow hover:scale-105 transition-transform min-h-[200px]">
            <h4 className="text-xl sm:text-2xl font-black mb-3 sm:mb-4">מוכן להתחיל?</h4>
